          ...
          <div className="boder flex flex-col justify-evenly">
            ...
            <div className=" w-[370px] flex flex-wrap">
              <h6>
                © 2021 Макароншоп
                <br />
                ООО"Квантум", Санкт-Петербург, улица Маршала Тухачевского, дом
                22
              </h6>
            </div>
          </div>
          <div className="flex gap-24  leading-7">
            <div className=" mr-8">
              <h1 className="w-[116px] h-[19px] text-[16px] gap-10 mt-11 font-bold uppercase mb-3">
                Информация
              </h1>
            ...
            <div className="mr-8 leading-7">
              <h1 className="w-[116px] h-[19px] text-[16px] mt-11 font-bold uppercase mb-3">
                Каталог
              </h1>
              <h5 className="text-[14px]">
                Готовые наборы
            ...
            <div className="flex flex-col items-center">
              <div className="flex flex-col">
                <h1 className=" text-[16px] mt-11 font-bold mb-2">
                  +7 (812) 309 82 88
                </h1>
              ...
              <div className="flex mt-12 gap-3">
                <img
                  className=" w-[24px] h-[24px] bg-[#FFFFFF]"
                  src={inst}
                  alt=""
                />
                <img className=" w-[24px] h-[24px]" src={face} alt="" />
                <img className=" w-[24px] h-[24px]" src={tvi} alt="" />
              </div>
            </div>
          </div>
        </div>
